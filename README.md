# Showerview
Particleshower viewer for a modified [Corsika](https://www.ikp.kit.edu/corsika/) simulatin

The Software should run on any system with OpenGL 3.3+ Support

Its currently under heavy development, so breaking changes can occur on daily basis.
